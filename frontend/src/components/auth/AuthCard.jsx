function AuthCard({
  ...
  return (
    <section className={`w-full rounded-[26px] border border-[#DDD6FF] bg-white/95 p-5 shadow-[0_18px_55px_rgba(75,55,160,0.11)] backdrop-blur md:p-6 ${wide ? 'max-w-[520px]' : 'max-w-[390px]'}`}>
